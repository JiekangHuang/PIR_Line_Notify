...
// HTTP Server Setting, using maker.ifttt.com for example
#define KEY "<YOUR IFTTT WEBHOOK KEY>"
#define EVENT_NAME "IR_Trig"
#define HTTP_PORT 80
#define HTTP_SERVER "maker.ifttt.com"
#define HTTP_API "trigger/" EVENT_NAME "/with/key/" KEY
